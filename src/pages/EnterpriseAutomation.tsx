...
export default function EnterpriseAutomation() {
    const { t } = useTranslation('enterpriseautomation')

    const features = [
    {
        icon: Target,
        title: t('benefits.features.scalableEfficiency.title'),
        description: t('benefits.features.scalableEfficiency.description')
    },
    {
        icon: Globe,
        title: t('benefits.features.smartIntegration.title'),
        description: t('benefits.features.smartIntegration.description')
    },
    {
        icon: Lightbulb,
        title: t('benefits.features.improvedAccuracy.title'),
        description: t('benefits.features.improvedAccuracy.description')
    },
    {
        icon: Users,
        title: t('benefits.features.employeeEmpowerment.title'),
        description: t('benefits.features.employeeEmpowerment.description')
    }
]

const usecases = [
    {
        name: t('useCases.items.finance.name'),
        description: t('useCases.items.finance.description'),
        icon: LockIcon,
    },
    {
        name: t('useCases.items.hr.name'),
        description: t('useCases.items.hr.description'),
        icon: CloudUpload,
    },
    {
        name: t('useCases.items.itOps.name'),
        description: t('useCases.items.itOps.description'),
        icon: RefreshCw,
    },
    {
        name: t('useCases.items.cx.name'),
        description: t('useCases.items.cx.description'),
        icon: Fingerprint,
    },
]
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16 slide-up">
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
                            {t('benefits.title')} <span className="gradient-text">{t('benefits.title2')}</span>
                        </h2>
